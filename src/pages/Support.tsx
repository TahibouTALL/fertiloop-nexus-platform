...
import ChatModule from "@/components/support/ChatModule";
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <Tabs defaultValue="contact">
          <div className="flex justify-center mb-6">
            <TabsList>
              <TabsTrigger value="contact" className="flex gap-1 items-center">
          ...
          <TabsContent value="chat">
            <Card>
              ...
              <CardContent className="pt-6">
                ...
                <div className="mt-4 pt-4 border-t border-gray-100">
                  <p className="text-sm text-gray-600">
                    Notre équipe de support répond généralement dans les 10 minutes pendant les heures d'ouverture.
                    En dehors de ces heures, nous vous répondrons dès que possible le jour ouvrable suivant.
                  </p>
                </div>
              </CardContent>
            </Card>
          ...
          <TabsContent value="feedback">
            <Card>
              <CardHeader className="border-b border-gray-100">
                <div className="flex items-center">
                  <div className="h-10 w-10 bg-fertiloop-yellow/20 rounded-full flex items-center justify-center mr-3">
                    <Star className="h-5 w-5 text-fertiloop-yellow" />
                  </div>
                  <div>
                    <CardTitle>Avis et évaluations</CardTitle>
                    <p className="text-sm text-gray-500 mt-1">
                      Partagez votre expérience avec nous et consultez les avis d'autres clients
                    </p>
                  </div>
                </div>
              </CardHeader>
