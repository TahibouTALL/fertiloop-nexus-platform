...
import { Trash2, Recycle, Truck, ArrowRight } from "lucide-react";

const Hero = () => {
  return (
    <div className="bg-gradient-to-br from-fertiloop-beige via-fertiloop-beige-light to-fertiloop-beige py-8 sm:py-12 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:grid lg:grid-cols-12 lg:gap-8">
          <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left">
            ...
            <motion.h1 
              className="mt-8 text-3xl sm:text-4xl lg:text-5xl tracking-tight font-extrabold text-fertiloop-green-dark"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center lg:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
              ...
              >
                <Link
                  to="/register"
                  className="w-full sm:w-auto flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-gradient-to-r from-fertiloop-blue to-fertiloop-blue-dark hover:shadow-lg transition-all duration-300"
                >
                  S'inscrire
              ...
              >
                <Link
                  to="/services"
                  className="w-full sm:w-auto flex items-center justify-center px-8 py-3 border border-fertiloop-green text-base font-medium rounded-lg text-fertiloop-green bg-white hover:bg-gray-50 hover:shadow-lg transition-all duration-300"
                >
                  Nos services
                </Link>
              </motion.div>
          ...
          <div className="mt-12 relative sm:max-w-lg sm:mx-auto lg:mt-0 lg:max-w-none lg:mx-0 lg:col-span-6 lg:flex lg:items-center">
            ...
            <motion.div 
              className="absolute -top-6 -left-6 bg-fertiloop-green/90 p-3 rounded-full shadow-lg text-white"
            ...
            <motion.div 
              className="absolute top-1/2 -right-4 bg-fertiloop-yellow/90 p-3 rounded-full shadow-lg text-white"
              initial={{ y: -50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
            ...
            <motion.div 
              className="absolute -bottom-4 left-1/3 bg-fertiloop-blue/90 p-3 rounded-full shadow-lg text-white"
              initial={{ y: 50, opacity: 0 }}
              animate={{ y: 0, opacity: 1 }}
